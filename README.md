...
[data/processed](data/processed/) : contains processed data. It could be cleaned data or any output of scripts written in [R](R) folder.<br>
[plots](plots/): contains the plots generated by the notebooks.
