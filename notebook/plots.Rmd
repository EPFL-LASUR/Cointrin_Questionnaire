...
```{r}
create_heat_map(data, "v_6_r", "v_14_r", percent = TRUE)
```
...
This code block creates a stacked barplot with a "special recoded" variable. "special recoded" varaibles start at v_700.
```{r}
create_stacked_barplot(data, "v_706", show_values = TRUE, percent = FALSE, custom_labels = c("A", "B", "C", "D"))
```
