...
```{r}
here::i_am(file.path("R", "data_cleaning.Rmd"))
source(here::here(file.path("R", "util.R")))
...
In this code block, we are removing users that answered to at least one open questions in an other language than french.
```{r}
